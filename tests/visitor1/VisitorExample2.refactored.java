...
{
	public void visit(Polygon addStyle);
	public void visit(Rectangle hasStyle);
	public void visit(Arrow getStyle);
}
...
class DoVisitorShape implements VisitorShape
{
	@Override
	public void visit(Polygon addStyle)
	{
	...
	public void visit(Rectangle hasStyle)
	{
	returngetStyles().contains(style);
	}
	@Override
	public void visit(Arrow getStyle)
	{
