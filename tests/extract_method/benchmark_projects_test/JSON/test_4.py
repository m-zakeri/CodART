...
def main():
    ...
    _conf['output_file'] = base_dir + 'tests/extract_method/out/' +project_root + str(target_file).replace(".","/") + '_test_4.java'
    _conf['new_method_name'] = 'emitContentInBody'
    print('conf:',_conf)
    extract_method(_conf)

if __name__ == '__main__':
    # main()
    # there seems to be some problem with this candidate as djeodorant itself can't refactor it.
    pass
