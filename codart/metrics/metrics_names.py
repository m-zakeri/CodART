...
metric_map = {
    ...
    'CSORD_AvgCountLineCode': 'CSLOC_AVG',
...
class_ordinary_metrics_names = [
    ...
    'AvgCountLineCode', 'AvgLineCodeDecl', 'AvgLineCodeExe',
    ...
    # 2.1.20-40. CSCC_NAMM
    'SumCyclomaticNAMM',
    # 'SumCyclomaticModifiedNAMM',
    # 'SumCyclomaticStrictNAMM',
    # 'SumEssentialNAMM',
    'MaxCyclomaticNAMM',
    # 'MaxCyclomaticModifiedNAMM',
    # 'MaxCyclomaticStrictNAMM',
    # 'MaxEssentialNAMM',
    'AvgCyclomaticNAMM',
    # 'AvgCyclomaticModifiedNAMM',
    # 'AvgCyclomaticStrictNAMM',
    # 'AvgEssentialNAMM',
...
project_metrics_names = [
    ...
    # 1.1 Systematic count/size metrics
    'CountLineCode', 'CountLineCodeDecl', 'CountLineCodeExe',
    'AvgCountLine', 'AvgLineCodeDecl', 'AvgLineCodeExe',
    'MaxLineCode', 'MaxLineCodeDecl', 'MaxLineCodeExe',
    'MinLineCode', 'MinLineCodeDecl', 'MinLineCodeExe',
    'SDLineCode', 'SDLineCodeDecl', 'SDLineCodeExe',
