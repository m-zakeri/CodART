...
class Config:
    ...
    def load_from_args(self):
        self.PREDICT = True
        self.MODEL_SAVE_PATH = "/home/y/Downloads/models/java14_model/saved_model_iter8_custom.release"
    ...
    def __init__(self, set_defaults: bool = False, load_from_args: bool = True, verify: bool = False):
