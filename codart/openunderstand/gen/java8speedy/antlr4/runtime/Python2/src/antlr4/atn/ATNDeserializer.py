...
class ATNDeserializer(object):
    ...
    def edgeFactory(self, atn, type, src, trg, arg1, arg2, arg3, sets):
        ...
        if self.edgeFactories is None:
            ...
            ef[Transition.EPSILON] = (
                lambda atn, src, trg, arg1, arg2, arg3, sets, target: EpsilonTransition(
                    target
                )
            )
            ef[Transition.RANGE] = (
    ...
    def lexerActionFactory(self, type, data1, data2):
        if self.actionFactories is None:
            ...
            af[LexerActionType.CUSTOM] = lambda data1, data2: LexerCustomAction(
                data1, data2
            )
            ...
            af[LexerActionType.POP_MODE] = (
                lambda data1, data2: LexerPopModeAction.INSTANCE
            )
            af[LexerActionType.PUSH_MODE] = lambda data1, data2: LexerPushModeAction(
                data1
            )
