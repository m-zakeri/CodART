...
class LexerNoViableAltException(RecognitionException):
    def __init__(self, lexer, input, startIndex, deadEndConfigs):
        super(LexerNoViableAltException, self).__init__(
            message=None, recognizer=lexer, input=input, ctx=None
        )
...
class NoViableAltException(RecognitionException):
    def __init__(
        ...
        super(NoViableAltException, self).__init__(
            recognizer=recognizer, input=input, ctx=ctx
        )
...
class InputMismatchException(RecognitionException):
    def __init__(self, recognizer):
        super(InputMismatchException, self).__init__(
...
class FailedPredicateException(RecognitionException):
    def __init__(self, recognizer, predicate=None, message=None):
        super(FailedPredicateException, self).__init__(
