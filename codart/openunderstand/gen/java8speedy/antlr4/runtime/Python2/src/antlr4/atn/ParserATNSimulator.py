...
#
# <p>
# The basic complexity of the adaptive strategy makes it harder to ounderstand.
...
class ParserATNSimulator(ATNSimulator):
    ...
    def getEpsilonTarget(
        self, config, t, collectPredicates, inContext, fullCtx, treatEofAsEpsilon
    ):
    ...
    def getTokenName(self, t):
        ...
        if (
            ...
            return self.parser.literalNames[t] + "<" + unicode(t) + ">"
        else:
            return unicode(t)
    ...
    def reportAttemptingFullContext(
        self, dfa, conflictingAlts, configs, startIndex, stopIndex
    ):
