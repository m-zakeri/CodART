...
public class Evaluation implements Summarizable, RevisionHandler, Serializable {
  private transient EvaluationHelper evaluationHelper = new EvaluationHelper();

  private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
    this.evaluationHelper = (EvaluationHelper) stream.readObject();
  ...
  public static String evaluateModel(Classifier classifier, String[] options)
    ...
    boolean noOutput, trainStatistics, printMargins = false, printComplexityStatistics = false, printGraph = false, classStatistics = false, printSource = false;
    ...
    try {
      ...
      if (options.length >= 0) System.arraycopy(options, 0, optionsTmp, 0, options.length);
    ...
    Evaluation testingEvaluation = new Evaluation(new Instances(template, 0),
            costMatrix);
    if (classifier instanceof InputMappedClassifier) {
      Instances mappedClassifierHeader = ((InputMappedClassifier) classifier)
    ...
    if (testSource != null) {
      ...
      if (splitPercentage > 0) {
        ...
        if (classificationOutput == null) {
          text.append("\n\n").append(testingEvaluation.toSummaryString(
                  "=== Error on test data ===\n", printComplexityStatistics));
        }
      }
  ...
  protected double evaluationForSingleInstance(Classifier classifier,
    ...
    if (classifier instanceof InputMappedClassifier) {
      ...
      instance = ((InputMappedClassifier) classifier)
              .constructMappedInstance(instance);
      // System.out.println("Mapped instance " + instance);
      int mappedClass = ((InputMappedClassifier) classifier)
              .getMappedClassIndex();
   ...
   * @throws Exception if model could not be evaluated successfully
   */
  public void evaluateModelOnceAndRecordPrediction(double[] dist,
                                                   Instance instance) throws Exception {

    evaluationForSingleInstance(dist, instance, true);
  }
  ...
  public String toCumulativeMarginDistributionString() throws Exception {
    ...
    for (int i = 0; i <= k_MarginResolution; i++) {
      if (m_MarginCounts[i] != 0) {
        ...
        result.append(Utils.doubleToString(margin, 7, 3)).append(' ').append(Utils.doubleToString(cumulativeCount * 100 / m_WithClass, 7, 3)).append('\n');
      } else if (i == 0) {
        result = new StringBuilder(Utils.doubleToString(-1.0, 7, 3) + ' '
  ...
  public String toClassDetailsString(String title) throws Exception {
    ...
    for (int i = 0; i < m_NumClasses; i++) {
      text.append(
              "               " + Utils.doubleToString(evaluationHelper.truePositiveRate(i, this.m_ConfusionMatrix, this.m_NumClasses), 7, 3))
              .append("  ");
      text.append(Utils.doubleToString(evaluationHelper.falsePositiveRate(i, this.m_ConfusionMatrix, this.m_NumClasses), 7, 3))
              .append("  ");
    ...
    text.append("Weighted Avg.  "
            + Utils.doubleToString(evaluationHelper.weightedTruePositiveRate(this.m_ConfusionMatrix, this.m_NumClasses), 7, 3));
    text.append("  " + Utils.doubleToString(evaluationHelper.weightedFalsePositiveRate(this.m_ConfusionMatrix,this.m_NumClasses), 7, 3));
  ...
  public double numTruePositives(int classIndex) {
    return evaluationHelper.numTruePositives(classIndex, this.m_ConfusionMatrix, this.m_NumClasses);
  }
  ...
  public double truePositiveRate(int classIndex) {
    return evaluationHelper.truePositiveRate(classIndex, this.m_ConfusionMatrix, this.m_NumClasses);
  }
  ...
  public double weightedTruePositiveRate() {
    return evaluationHelper.weightedTruePositiveRate(this.m_ConfusionMatrix, this.m_NumClasses);
  }
  ...
  public double numTrueNegatives(int classIndex) {
    return evaluationHelper.numTrueNegatives(classIndex, this.m_ConfusionMatrix, this.m_NumClasses);
  }
  ...
  public double trueNegativeRate(int classIndex) {
    return evaluationHelper.trueNegativeRate(classIndex, this.m_ConfusionMatrix, this.m_NumClasses);
  }
  ...
  public double weightedTrueNegativeRate() {
    return evaluationHelper.weightedTrueNegativeRate(this.m_ConfusionMatrix, this.m_NumClasses);
  }
  ...
  public double numFalsePositives(int classIndex) {
    return evaluationHelper.numFalsePositives(classIndex, this.m_ConfusionMatrix, this.m_NumClasses);
  }
  ...
  public double falsePositiveRate(int classIndex) {
    return evaluationHelper.falsePositiveRate(classIndex, this.m_ConfusionMatrix, this.m_NumClasses);
  }
  ...
  public double weightedFalsePositiveRate() {
    return evaluationHelper.weightedFalsePositiveRate(this.m_ConfusionMatrix, this.m_NumClasses);
  }
  ...
  public double numFalseNegatives(int classIndex) {
    return evaluationHelper.numFalseNegatives(classIndex, this.m_ConfusionMatrix, this.m_NumClasses);
  }
  ...
  public double matthewsCorrelationCoefficient(int classIndex) {
    double numTP = evaluationHelper.numTruePositives(classIndex, this.m_ConfusionMatrix, this.m_NumClasses);
    double numTN = evaluationHelper.numTrueNegatives(classIndex, this.m_ConfusionMatrix, this.m_NumClasses);
    double numFP = evaluationHelper.numFalsePositives(classIndex, this.m_ConfusionMatrix, this.m_NumClasses);
    double numFN = evaluationHelper.numFalseNegatives(classIndex, this.m_ConfusionMatrix, this.m_NumClasses);
  ...
  public double unweightedMacroFmeasure() {
    ...
    for (int c = 0; c < m_NumClasses; c++) {
      ...
      if (evaluationHelper.numTruePositives(c, this.m_ConfusionMatrix, this.m_NumClasses) + evaluationHelper.numFalseNegatives(c, this.m_ConfusionMatrix, this.m_NumClasses) > 0) {
        rr.add(fMeasure(c));
      }
    }
    rr.calculateDerived();
  ...
  public double unweightedMicroFmeasure() {
    ...
    double fp = 0;
    for (int c = 0; c < m_NumClasses; c++) {
      tp += evaluationHelper.numTruePositives(c, this.m_ConfusionMatrix, this.m_NumClasses);
      fn += evaluationHelper.numFalseNegatives(c, this.m_ConfusionMatrix, this.m_NumClasses);
      fp += evaluationHelper.numFalsePositives(c, this.m_ConfusionMatrix, this.m_NumClasses);
    }
  ...
  protected void updateStatsForIntervalEstimator(IntervalEstimator classifier,
    ...
    for (double[] pred : preds) {
      m_TotalSizeOfRegions += (pred[1] - pred[0])
  ...
  private void writeObject(ObjectOutputStream stream) throws IOException {
    ...
    stream.writeObject(this.evaluationHelper);
  }
}
