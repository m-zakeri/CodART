 ...
 * data from an MSPDI file into the GanttProject application.
 */
public class GanttMSPDIOpen extends GanttMPXJOpen
{
    ...
    * Constructor.
    */
   public GanttMSPDIOpen (GanttTree tasks, GanttProject project)
   {
      super (tasks, project);
   }
   ...
   {
      return (load(MSPDIFile.class, file, null));
   }
   ...
   {
      return (load(MSPDIFile.class, null, is));
   }
}
