 ...
 * @author bard
 */
public class ResourcesRendererImpl extends ChartRendererBase implements TimeUnitVisitor {
	...
	public void afterProcessingTimeFrames() {
		...
		for (int i=0; i<visibleTasks.size(); i++) {
			...
			if (assignments.length>0) {
				...
				Text text = getPrimitiveContainer().createText(0, bottomY, resources.toString());
