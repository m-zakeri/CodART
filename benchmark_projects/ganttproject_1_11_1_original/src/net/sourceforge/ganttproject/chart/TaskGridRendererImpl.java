 ...
 * @author bard
 */
public class TaskGridRendererImpl extends ChartRendererBase implements TimeUnitVisitor {
	...
	public void beforeProcessingTimeFrames() {
		...
		for (int i=0; i<tasks.size(); i++) {
			//GraphicPrimitiveContainer.Rectangle nextRect = getPrimitiveContainer().createRectangle(0, ypos, (int)getChartModel().getBounds().getWidth(), rowHeight-1);
