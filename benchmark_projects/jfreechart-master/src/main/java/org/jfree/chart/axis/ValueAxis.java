...
public abstract class ValueAxis extends Axis
     ...
     * @since 1.0.4
     */
    public void drawDomainCrosshair(Graphics2D g2, Rectangle2D dataArea,
                                    PlotOrientation orientation, double value,
        ...
        if (orientation == PlotOrientation.VERTICAL) {
            double xx = valueToJava2D(value, dataArea,
                    RectangleEdge.BOTTOM);
            line = new Line2D.Double(xx, dataArea.getMinY(), xx,
                    dataArea.getMaxY());
        } else {
            double yy = valueToJava2D(value, dataArea,
                    RectangleEdge.LEFT);
     ...
     * @since 1.0.4
     */
    public void drawRangeCrosshair(Graphics2D g2, Rectangle2D dataArea,
                                   PlotOrientation orientation, double value,
                                   Stroke stroke, Paint paint) {
