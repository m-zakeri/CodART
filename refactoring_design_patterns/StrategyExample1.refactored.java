...
public class CBZip2InputStream extends InputStream implements BZip2Constants {
	...
	public CBZip2InputStream(MyStrategy strategy){
		this.strategy = strategy;
	}
	public int readStrategy(byte[] dest, int len){
		return strategy.doOperation( dest,  len);
	}
...
interface MyStrategy {
	public int doOperation(byte[] dest, int len);
}
...
class SubNewClass2 implements MyStrategy{
	...
	public int doOperation(byte[] dest, int len)
	{
            throw new IndexOutOfBoundsException("len(" + offs + ") = -1.");
        }
}
