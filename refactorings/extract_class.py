...
class ExtractClassRefactoringListener(JavaParserLabeledListener):
    ...
    def enterClassDeclaration(self, ctx: JavaParserLabeled.ClassDeclarationContext):
        ...
        if class_identifier == self.source_class:
            ...
            self.state=True
            self.added += f"class {self.new_class}{self.NEW_LINE}" + "{" + self.NEW_LINE
        else:
            self.is_source_class = False
    ...
    def exitFieldDeclaration(self, ctx: JavaParserLabeled.FieldDeclarationContext):
        ...
        if self.detected_field in field_names:
            ...
            if (self.started == False):
                self.added += f"{self.TAB}{modifier} {field_type} {self.detected_field};{self.NEW_LINE}"
