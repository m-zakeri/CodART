...
class ExtractClassAPI:
    def __init__(self, project_dir, file_path, source_class, new_class, moved_fields, moved_methods):
        ...
        self.new_file_path = "/home/ali/Documents/dev/CodART/input.refactored.java"
        self.source_class = source_class
        self.new_class = new_class
        self.moved_fields = moved_fields
        self.moved_methods = moved_methods
    ...
    def find_usages(self, new_code):
        ...
        listener = FindClassUsagesListener(
...
if __name__ == "__main__":
    ExtractClassAPI(
        project_dir="/home/ali/Documents/dev/CodART",
        file_path="/home/ali/Documents/dev/CodART/input.java",
        source_class="A",
        new_class="APlus",
        moved_fields=["h"],
