...
class PropagationIncreaseFieldVisibilityRefactoringListener(JavaParserLabeledListener):
    def __init__(self, common_token_stream: CommonTokenStream = None, using_field_name=None, object_name=None,
        ...
        using_field_name : str
           Name of the field which has to be propagated

        object_name : str
           Name of the objects that need to be changed with the propagation operation

        propagated_class_name:str
            Name of the class in which the propagation operation needs to be implemented
...
class PropagationIncreaseFieldVisibility_GetObjects_RefactoringListener(JavaParserLabeledListener):
    def __init__(self, common_token_stream: CommonTokenStream = None, source_class=None,
        ...
        """
           ...
           source_class : str
                Name of the class in which the propagation has to be implemented

           propagated_class_name : str
                Name of the class which has to be propagated
